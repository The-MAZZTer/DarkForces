namespace CSharpSynth.Midi {
  public class MidiEvent {
    ...
    public bool IsMetaEvent() => this.midiChannelEvent == MidiHelper.MidiChannelEvent.None;
    public bool IsChannelEvent() => this.midiMetaEvent == MidiHelper.MidiMetaEvent.None;
    public MidiHelper.ControllerType GetControllerType() {
      if (this.midiChannelEvent != MidiHelper.MidiChannelEvent.Controller) {
